...
const DEFAULT_DATA = {
  ...
  settings: {
    ...
    // Valeurs par défaut indicatives (messagerie / − 3,5 t), à ajuster.
    tenderParams: {
      driverCost: 2900,     // coût chauffeur mensuel chargé (salaire + charges) €
      daysPerMonth: 21,     // jours travaillés / mois
      vehicleCost: 1300,    // leasing + assurance + entretien mensuel €
      consumption: 9,       // consommation L/100 km
      fuelPrice: 1.75,      // prix du gasoil €/L
      tyresPerMonth: 120,   // pneumatiques amortis / mois €
      overheadPct: 12,      // frais de structure (% du coût direct)
      marginPct: 10,        // marge / bénéfice cible (%)
      cnrRef: 100,          // indice CNR de référence (base 100)
      cnrCurrent: 100,      // indice CNR M-1 (base 100) — relevé sur cnr.fr
      pointsPerDay: 90,     // nombre de points livrés / jour
      kmPerDay: 120,        // km parcourus / jour
    },
