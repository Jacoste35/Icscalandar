...
// "interval" = kilométrage indicatif par défaut entre deux remplacements ;
// il est affiné automatiquement par la moyenne des remplacements réellement
// enregistrés (voir l'analyse de la flotte côté serveur). Éditable plus tard.
const DEFAULT_CONSUMABLES = [
  { code: 'pneus_av', label: 'Pneus avant', interval: 40000 },
  { code: 'pneus_ar', label: 'Pneus arrière', interval: 40000 },
  { code: 'freins_av', label: 'Freins avant', interval: 50000 },
  { code: 'freins_ar', label: 'Freins arrière', interval: 60000 },
  { code: 'service_a', label: 'Service A (révision intermédiaire)', interval: 25000 },
  { code: 'service_b', label: 'Service B (grande révision)', interval: 50000 },
  { code: 'vidange', label: 'Vidange', interval: 20000 },
];
