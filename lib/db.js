...
const DEFAULT_SCHOOL_HOLIDAYS_ZONE_B = [
  { label: 'Toussaint 2025', start: '2025-10-18', end: '2025-11-03' },
  { label: 'Noël 2025', start: '2025-12-20', end: '2026-01-05' },
...
function migrate(d) {
  ...
  if (!Array.isArray(d.settings.schoolHolidays)) d.settings.schoolHolidays = JSON.parse(JSON.stringify(DEFAULT_SCHOOL_HOLIDAYS_ZONE_B));
