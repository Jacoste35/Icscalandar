...
function ensureErp(data) {
  ...
  if (!data.settings.pajgps || typeof data.settings.pajgps !== 'object') {
    ...
    if (typeof g.vehicleFixedDays !== 'number') g.vehicleFixedDays = 22; // jours travaillés / mois (prorata)
  }
