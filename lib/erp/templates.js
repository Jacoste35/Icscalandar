...
// Mise à pied DISCIPLINAIRE — procédure complète : Lettre n°1 (convocation) puis
// Lettre n°2 (notification). La durée doit respecter le plafond du règlement intérieur.
const MISE_A_PIED_DISCIPLINAIRE = `${MAP_HEAD}
<p class="meta"><strong>Lettre n°1 — Convocation à l'entretien préalable</strong></p>
<p><strong>Objet : Convocation à un entretien préalable à une éventuelle sanction disciplinaire</strong></p>
<p>Madame, Monsieur,</p>
<p>Nous envisageons de prendre une sanction disciplinaire à votre encontre en raison des faits suivants :</p>
<p>{{faits}}</p>{{#if historique}}
<p>{{historique}}</p>{{/if}}
<p>Conformément aux articles L.1332-1 et suivants du Code du travail, nous vous convoquons à un entretien préalable qui se tiendra le : <strong>[jour, date]</strong> à <strong>[heure]</strong>, à l'adresse suivante : {{company.address}}.</p>
...
${MAP_HEAD}
<p class="meta"><strong>Lettre n°2 — Notification de la mise à pied disciplinaire</strong><br><em>À envoyer entre 2 jours ouvrables et 1 mois après l'entretien.</em></p>
...
const DEFAULT_TEMPLATES = {
  ...
  mise_a_pied_disciplinaire: { label: 'Mise à pied disciplinaire', body: MISE_A_PIED_DISCIPLINAIRE, category: 'Disciplinaire' },
