...
// Mise à pied DISCIPLINAIRE (sanction, sans solde) — activable après franchissement
// du seuil d'avertissements pour le motif considéré.
const MISE_A_PIED_DISCIPLINAIRE = `
<div class="lh"><div class="lh-co">{{company.legal}}</div><div class="lh-ad">{{company.address}}</div></div>
<p class="addr">{{salarie.fullName}}<br>{{salarie.address}}</p>
<p class="meta">Éterville, le {{date}}</p>
<p><strong>Objet : Mise à pied disciplinaire – {{motif}}</strong></p>
<p class="meta">Réf. : Contrat de travail – CCN Transports Routiers et Activités Auxiliaires (IDCC 16) – Règlement Intérieur ICS<br>Envoi : LRAR / remise en main propre contre décharge (Art. L.1332-1 C. trav.)</p>
<p>{{salarie.civilite}},</p>
<p>{{faits}}</p>
<p>Ces faits constituent une réitération de manquements de même nature, déjà sanctionnés à ce jour par <strong>{{miseAPied.warningCount}}</strong> avertissement(s) versé(s) à votre dossier disciplinaire. Leur persistance caractérise une désorganisation du service au sens de la jurisprudence de la Chambre sociale (Cass. soc. 19 mai 2016, n° 14-26.398).</p>
<p>En conséquence, sur le fondement des articles L. 1331-1 et L. 1333-2 du Code du travail et de l'article 20 (2°) du règlement intérieur d'ICS, nous vous notifions une <strong>MISE À PIED DISCIPLINAIRE sans solde d'une durée de {{miseAPied.jours}} jour(s)</strong>, mesure proportionnée à la gravité {{miseAPied.graviteLabel}} des faits et à la désorganisation occasionnée. Cette suspension de votre contrat, sans rémunération, prendra effet selon les modalités qui vous seront précisées.</p>
<p>Cette sanction fait suite à l'entretien préalable auquel vous avez été régulièrement convoqué, conformément aux articles L. 1332-2 et R. 1332-1 du Code du travail. Nous vous rappelons que toute nouvelle récidive pourra être sanctionnée par une mesure pouvant aller jusqu'au licenciement pour faute grave.</p>
<p>Vous disposez d'un délai de dix jours ouvrables à compter de la réception du présent courrier pour formuler par écrit toute observation.</p>
<p>Veuillez agréer, {{salarie.civilite}}, l'expression de nos salutations distinguées.</p>
<p class="sign">M. Quentin Routel<br>Directeur – {{company.legal}}</p>`;

// Mise à pied CONSERVATOIRE (mesure d'attente, non disciplinaire) — réservée aux
// fautes graves justifiant l'éloignement immédiat dans l'attente de la procédure.
const MISE_A_PIED_CONSERVATOIRE = `
<div class="lh"><div class="lh-co">{{company.legal}}</div><div class="lh-ad">{{company.address}}</div></div>
<p class="addr">{{salarie.fullName}}<br>{{salarie.address}}</p>
<p class="meta">Éterville, le {{date}}</p>
<p><strong>Objet : Mise à pied conservatoire – {{motif}}</strong></p>
<p class="meta">Réf. : Contrat de travail – CCN Transports Routiers et Activités Auxiliaires (IDCC 16) – Règlement Intérieur ICS<br>Envoi : LRAR / remise en main propre contre décharge</p>
<p>{{salarie.civilite}},</p>
<p>{{faits}}</p>
<p>La gravité de ces faits rend impossible votre maintien à votre poste pendant la durée de la procédure. En conséquence, sur le fondement de l'article L. 1332-3 du Code du travail, nous vous notifions une <strong>MISE À PIED À TITRE CONSERVATOIRE</strong> à effet immédiat. Cette mesure, qui n'est pas une sanction, suspend votre contrat de travail dans l'attente de la décision définitive qui sera prise à l'issue de la procédure disciplinaire engagée à votre encontre.</p>
<p>Vous serez convoqué, par courrier distinct, à un entretien préalable conformément aux articles L. 1332-2 et suivants du Code du travail. À l'issue de cette procédure, la sanction éventuellement prononcée — pouvant aller jusqu'au licenciement pour faute grave — vous sera notifiée. Le sort de la rémunération afférente à la période de mise à pied conservatoire sera déterminé en fonction de la sanction définitive.</p>
<p>Nous vous demandons de restituer sans délai l'ensemble des matériels et documents de l'entreprise en votre possession (véhicule, carte carburant, badge, documents de tournée).</p>
<p>Veuillez agréer, {{salarie.civilite}}, l'expression de nos salutations distinguées.</p>
<p class="sign">M. Quentin Routel<br>Directeur – {{company.legal}}</p>`;
